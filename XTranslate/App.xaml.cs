...
public partial class App : Application
{
    ...
    private const string MutexName = "XTranslate.SingleInstance.Mutex";
    private const string ShowEventName = "XTranslate.SingleInstance.ShowEvent";
    ...
    private void Application_Startup(object sender, StartupEventArgs e)
    {
        ...
        Log.Debug("[XTranslate] App startup complete with DI container.");
    }
    ...
    private void StartShowSignalListener()
    {
        ...
        {
            IsBackground = true,
            Name = "XTranslate-ShowSignalListener"
        };
